...
| [make-command.md](make-command.md) | Spritey's make slices provide Python-parity frame path resolution, deterministic vertical-strip output, readiness-gated validation, single/batch stable envelopes, additive report provenance, and output artifact-integrity metadata. | spritey, make, render | 2026-05-10 |
...
| [inspect-layer.md](inspect-layer.md) | Spritey's second product slice returns one catalog layer's metadata for agent recipe authoring. | spritey, inspect, cli | 2026-05-10 |
| [recipe-validation.md](recipe-validation.md) | Spritey's validation slices cover recipe metadata validation plus render-input readiness checks. | spritey, validate, recipes | 2026-05-10 |

## Recent Changes

- 2026-05-10: Updated make-command concept for Python-parity A/B/C/D frame resolver behavior (spec 012).
...
- 2026-05-10: Updated recipe-validation and make-command concepts for render-input readiness behavior.
...
- 2026-05-10: Added inspect-layer concept.
